...
#define ssl_V3_SUITES_IMPLEMENTED 71 + MTG_NUMBER_OF_SUITES_IMPLEMENTED

#define MAX_DTLS_SRTP_CIPHER_SUITES 4

/* MAX_SIGNATURE_SCHEMES allows for all the values we support. */
#define MAX_SIGNATURE_SCHEMES 18 + MTG_NUMBER_OF_SIGNATURE_SCHEMES
